...
>
  <h3 style="margin-left: 0; margin-right: 0">
    <samp style="font-size: 1.5rem; color: #39d353">「</samp>
  </h3>
    ...
    >
      <samp>
        ...
        >
          Hello There
          <br />
          I'm <span style="color: #39d353">SOHAM</span>, Just A Computer Science
  ...
  <div style="margin: 20px 0; align-items: center; text-align: center">
  ...
  >
    <details
      ...
      "
    >
      <summary style="font-size: 1.5rem; cursor: pointer; color: #39d353">
        <samp>Status</samp>
      </summary>
        ...
        <table style="width: 100%; margin-bottom: 20px; border: 1px solid #555">
          <tr>
            <td style="text-align: left; padding: 10px">
              <h1 style="font-size: 1.5rem; color: #39d353">
                <samp>Discord</samp>
              </h1>
              <a href="">
                <img
  ...
  <h2 style="text-align: left; color: #39d353">GitHub Stats</h2>
  ...
  <h2 style="text-align: left; color: #39d353">Language And Tools</h2>

  <div style="margin: 20px 0">
    <h3 style="color: #39d353"><samp>Languages</samp></h3>
    <div style="margin-bottom: 20px">
      <a
        ><img
          src="https://skillicons.dev/icons?i=python,cpp,html,css,javascript,csharp,java,bash&theme=dark"
          style="margin-right: 10px"
      /></a>
    </div>

    <h3 style="color: #39d353"><samp>Technologies</samp></h3>
    <div style="margin-bottom: 20px">
      <a
        ><img
    ...
    <h3 style="color: #39d353"><samp>Design & Creativity</samp></h3>
    <div style="margin-bottom: 20px">
      <a
        ><img
    ...
    <h3 style="color: #39d353"><samp>Database</samp></h3>
    <div style="margin-bottom: 20px">
      <a
        ><img
    ...
    <h3 style="color: #39d353"><samp>Tools</samp></h3>
    <div style="margin-bottom: 20px">
      <a
        ><img
